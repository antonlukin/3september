...
jQuery(function(n){var t={count:n("#count"),every:n("#every"),sound:n("#sound"),calendar:n("#calendar"),video:n("#background-video"),callback:function(){},turn:function(){n.post("/app",{increment:1});var e=t.count.find("strong"),u=e.data("count")+1;return e.text(t.sanitize(u)).data("count",u),t.count.fadeIn()},sanitize:function(n){return n<2||n>4?n+" раз":n+" раза"},get:function(){n.ajax({type:"GET",url:"/app",timeout:5e3,success:function(n){if(n.success)return t.every.find("strong").text(t.sanitize(n.success)),t.every.fadeIn()}},"json")},run:function(n){t.video.YTPlayer({fitToBackground:!0,mute:!1,videoId:n,modestbranding:0,autoplay:1,controls:0,autohide:0,callback:function(){t.callback}})},mute:function(){var n=t.video.data("ytPlayer").player;return t.sound.toggleClass("mute"),t.sound.hasClass("mute")?n.mute():n.unMute()},init:function(){t.get(),t.run("0T4fRpS-tbg"),t.sound.on("click",t.mute),t.calendar.on("click",t.turn)}};n(document).ready(t.init)});