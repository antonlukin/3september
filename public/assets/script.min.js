...
jQuery(function(t){var n={count:t("#count"),every:t("#every"),sound:t("#sound"),calendar:t("#calendar"),video:t("#background-video"),callback:function(){},turn:function(){t.post("/app",{increment:1});var e=n.count.find("strong"),o=parseInt(e.data("count"))+1;return e.text(n.sanitize(o)).data("count",o),localStorage.setItem("count",o),n.count.fadeIn()},sanitize:function(t){return t<2||t>4?t+" раз":t+" раза"},get:function(){localStorage.getItem("count")&&(n.count.find("strong").data("count",parseInt(localStorage.getItem("count"))-1),n.turn()),t.ajax({type:"GET",url:"/app",timeout:5e3,success:function(t){if(t.success)return n.every.find("strong").text(n.sanitize(t.success)),n.every.fadeIn()}},"json")},run:function(t){n.video.YTPlayer({fitToBackground:!0,mute:!1,videoId:t,modestbranding:0,autoplay:1,controls:0,autohide:0,callback:function(){n.callback}})},mute:function(){var t=n.video.data("ytPlayer").player;return n.sound.toggleClass("mute"),n.sound.hasClass("mute")?t.mute():t.unMute()},init:function(){n.get(),n.run("0T4fRpS-tbg"),n.sound.on("click",n.mute),n.calendar.on("click",n.turn)}};t(document).ready(n.init)});
