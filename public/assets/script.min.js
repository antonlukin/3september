...
jQuery(function(n){var t={count:n("#count"),every:n("#every"),sound:n("#sound"),calendar:n("#calendar"),video:n("#background-video"),callback:function(){},turn:function(){n.post("/app",{increment:1});var e=t.count.find("strong"),o=parseInt(e.data("count"))+1;return e.text(t.sanitize(o)).data("count",o),localStorage.setItem("count",o),t.count.fadeIn()},spaces:function(n){return n.toString().replace(/\B(?=(\d{3})+(?!\d))/g," ")},sanitize:function(n){return n>9&&n<20?t.spaces(n)+" раз":n%10<2||n%10>4?t.spaces(n)+" раз":t.spaces(n)+" раза"},get:function(){localStorage.getItem("count")&&(t.count.find("strong").data("count",parseInt(localStorage.getItem("count"))-1),t.turn()),n.ajax({type:"GET",url:"/app",timeout:5e3,success:function(n){if(n.success)return t.every.find("strong").text(t.sanitize(n.success)),t.every.fadeIn()}},"json")},run:function(n){t.video.YTPlayer({fitToBackground:!0,mute:!1,videoId:n,modestbranding:0,autoplay:1,controls:0,autohide:0,callback:function(){t.callback}})},donate:function(){n(".donate").on("click",".donate-button",function(){n(this).fadeOut(function(){n(".donate-yandex").fadeIn().css("display","block")})})},mute:function(){var n=t.video.data("ytPlayer").player;return t.sound.toggleClass("mute"),t.sound.hasClass("mute")?n.mute():n.unMute()},init:function(){t.get(),t.run("0T4fRpS-tbg"),t.donate(),t.sound.on("click",t.mute),t.calendar.on("click",t.turn)}};n(document).ready(t.init)});
